...
import { CompactConnectionStatus } from './ConnectionStatus';
      ...
      <div className="flex items-start justify-between mb-4">
        <div className="flex-1">
          <div className="flex items-center space-x-2">
            ...
            {stock.isRealTime && (
              <div className="flex items-center space-x-1" title="Real-time data">
                <Zap className="w-3 h-3 text-profit-green" />
